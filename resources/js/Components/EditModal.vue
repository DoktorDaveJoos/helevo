                        ...
                        <DialogPanel
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900"> {{ copy.code }}
                                    </DialogTitle>
                                    <div class="mt-2">
                                        <div>
                                            <label for="price"
                                            ...
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input v-model="copy.amount" type="text" name="price" id="price"
                            ...
                            <div class="mt-5 sm:mt-6 space-y-2">
                                <button @click="updateVoucher" type="button"
...
watch(props, (oldVal, newProps) => {
    if (newProps.voucher === null) {
        return;
    }

    copy.value = newProps.voucher;
